...
<template>
  ...
  <div class="lg:h-165 py-8 flex-grow flex flex-col items-center justify-center font-display  gap-10 text-start text-brown-300 px-15 text-sm xl:text-xl xl:px-60">
    ...
    <div class="w-full">
      ...
      <p>A: Not right now since we can’t swim that fast but we have plans for expansion so wait on our good news! </p>
    </div>
    <div class="w-full">
    ...
    <div class="w-full">
      ...
      <p>A: Every single one of our dugongs are at least V26 climbers. Our shirts helped us push past the boundaries of V17.</p>
    </div>
  </div>
